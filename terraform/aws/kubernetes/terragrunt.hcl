...
terraform {
  source = "git::https://github.com/cloudopsworks/terraform-module-aws-eks-helm-deploy.git//?ref=v5.8.0"
}
...
inputs = {
  ...
  helm_chart_path  = try(local.local_vars.helm_chart_path, "${path_relative_from_include("root")}/../kubernetes/helm")
